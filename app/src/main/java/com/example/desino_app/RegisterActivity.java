...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerAPI() {
        ...
        String URL = "http://192.168.1.3/basewift/basewift/registro.php";
        ...
        try {
            ...
            datos.put("confirmPassword", txtPass2.getText().toString().trim());
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, URL, datos, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        fondoCarga.setVisibility(View.GONE);
                        progressBarCarga.setVisibility(View.GONE);
                        Toast.makeText(getApplicationContext(), "Ya existe un usuario", Toast.LENGTH_LONG).show();
                    }
                }
